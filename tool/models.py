...
class JakmallScrapper(models.Model):
	...
	price = models.IntegerField(default=0, verbose_name='Price (before discount cut)')
	final_price = models.IntegerField(default=0, verbose_name='Price')
	...
	weight = models.IntegerField(default=0, verbose_name='Weight (in Gram)')
